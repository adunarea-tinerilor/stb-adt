...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      // SITE UPDATE DATE:
      footerUpdateDate: "12 Decembrie 2022",
      ...
      nextDiscussedLink: "https://htdbrom.com/DC/DC7.htm",
      nextDiscussedLinkText: "Dezvoltarea Caracterului - Rugăciunea",
      ...
      meetingQuestionsStudyFormat: [
        "1. Ce este rugăciunea? „Rugăciunea este dorinţa sinceră a sufletului, exprimată sau neexprimată în cuvinte.”",
       
        "2a. Care este privilegiul şi puterea rugăciunii?",
        "2b. Care este privilegiul şi puterea rugăciunii?",
        
        "3a. Care este obiectivul rugăciunii?",
        "3b. Care este obiectivul rugăciunii?",
        "3c. Care este obiectivul rugăciunii?",

        "4a. Care este necesitatea rugăciunii?",
        "4b. Care este necesitatea rugăciunii?",
        "4c. Care este necesitatea rugăciunii?",
        "4d. Care este necesitatea rugăciunii?",
        "4e. Care este necesitatea rugăciunii?",

        "5. Care este necesitatea stăruinţei în rugăciune?",

        "6. Cui şi prin cine trebuie să ne rugăm?",

        "7a. În prezenţa cui trebuie să ne rugăm? În secret.",
        "7b. În prezenţa cui trebuie să ne rugăm? În prezenţa credincioşilor.",
        "7c. În prezenţa cui trebuie să ne rugăm? În prezenţa credincioşilor şi a necredincioşilor.",
        "7d. În prezenţa cui trebuie să ne rugăm? În adunarea publică a sfinţilor.",
        "7d - Reprint. În prezenţa cui trebuie să ne rugăm? În adunarea publică a sfinţilor.",

        "8a. În ce mod trebuie să ne apropiem de Dumnezeu în rugăciune?",
        "8b. În ce mod trebuie să ne apropiem de Dumnezeu în rugăciune?",
        "8c. În ce mod trebuie să ne apropiem de Dumnezeu în rugăciune?",

        "9a. Care trebuie să fie poziţia noastră în rugăciune?",
        "9b. Care trebuie să fie poziţia noastră în rugăciune?"

      ],


      nextMeetingQuestionsStudyFormat: [
        "Ce este rugăciunea? „Rugăciunea este dorinţa sinceră a sufletului, exprimată sau neexprimată în cuvinte.”",
        "Care este privilegiul şi puterea rugăciunii?",
        "Care este obiectivul rugăciunii?",
        "Care este necesitatea rugăciunii?",
        "Care este necesitatea stăruinţei în rugăciune?",
        "Cui şi prin cine trebuie să ne rugăm?",
        "În prezenţa cui trebuie să ne rugăm?",
        "În ce mod trebuie să ne apropiem de Dumnezeu în rugăciune?",
        "Care trebuie să fie poziţia noastră în rugăciune?"
      ...
      <HashRouter basename="/stb-adt">
        <div className="App">
          ...
          <Route path="/studyformat" render={() => <StudyFormat
            meetingQuestionsStudyFormat={this.state.meetingQuestionsStudyFormat}
